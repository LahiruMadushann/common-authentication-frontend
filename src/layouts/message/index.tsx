...
import { useLazyGetMessageQuery, useLazySendMessageQuery } from '@/src/app/services/message';
...
const MessageLayout = ({ senderId, receiverId }: any) => {
  ...
  const handleUpload = async (file: File): Promise<string> => {
    ...
    try {
      const fileName = `message-attachments/${file.name}`;
  ...
  return (
    <div className="">
      ...
      <div ref={messagesContainerRef} className="bg-[#F6F6F6] container_height overflow-y-auto p-4">
        {messageData
          ?.slice()
          .reverse()
          .map((message, index) => (
            <div
              ...
              <div
                ...
                <div className="w-full">
                  <div
                    className={`flex ${message?.senderId == senderId ? 'justify-end' : 'justify-start'} mb-1`}>
                    <span className="text-sm text-gray-500  px-2 py-1 bg-white rounded-sm shadow-sm">
